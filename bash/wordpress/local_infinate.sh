...
key=$(php56-cli wp-cli.phar option get iwp_client_activate_key)
url=$(php56-cli wp-cli.phar option get siteurl)
user=$(php56-cli wp-cli.phar user get 1 | grep user_login | awk '{print $2}')
